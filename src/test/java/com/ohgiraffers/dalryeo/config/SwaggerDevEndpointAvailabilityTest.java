...
@ActiveProfiles({"dev", "swagger-test"})
class SwaggerDevEndpointAvailabilityTest extends SwaggerEndpointTestSupport {

    @Test
    void devProfileServesOpenApiDocs() {
    ...
    @Test
    void devProfileServesSwaggerUi() {
